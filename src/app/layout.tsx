...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: publicAsset("icons/icon-192.png"), sizes: "192x192", type: "image/png" },
      { url: publicAsset("icons/icon-512.png"), sizes: "512x512", type: "image/png" },
    ],
    apple: publicAsset("icons/apple-touch-180.png"),
  },
  appleWebApp: {
    capable: true,
