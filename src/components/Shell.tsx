...
function Chrome() {
  ...
  // Register the service worker only in production and after window load so
  // it never interferes with first paint. Chrome won't offer "Install app" if
  // the SW registration fails, so we silently swallow errors.
  React.useEffect(() => {
